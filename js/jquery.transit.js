...
(function($) {
  ...
  $.cssHooks['transit:transform'] = {
    ...
    set: function(elem, v) {
      ...
      // translate is affected, but not risking it.  Detection code from
      // http://davidwalsh.name/detecting-google-chrome-javascript

      if (support.transform === 'WebkitTransform' || support.transform === 'transform') {
